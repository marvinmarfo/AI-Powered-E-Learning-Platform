        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Empowering everyone to learn without limits.
              Our inclusive learning platform makes education accessible, 
              engaging, and personalized for all.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/courses" className="text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary text-sm transition-colors">
                  All Courses
                </Link>
              </li>
              <li>
                <Link to="/learning-path" className="text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary text-sm transition-colors">
                  Learning Paths
                </Link>
              </li>
              <li>
